...
public class LifecycleProfiler extends AbstractEventSpy {
  ...
  public void onEvent(Object event) throws Exception {
	  ...
	  if(event instanceof ArtifactTransferEvent){
		  ArtifactTransferEvent e = (ArtifactTransferEvent) event;
		  System.out.println("[EventSpy] Transfer Size : " + e.getTransferredBytes());
	  }

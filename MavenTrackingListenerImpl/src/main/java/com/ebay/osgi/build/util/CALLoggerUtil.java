...
/**
 * CALLoggerUtil class provides methods for initialize CAL , methods for logging
 * transaction and events.
 * 
 * @author kmuralidharan
 *
 */
public final class CALLoggerUtil {
	
	private static final String CAL_TRAN_TYPE = "URL";
	private static JavaCalService calService;
	
	private CALLoggerUtil() {
	...
	public static CalTransaction startCALTransaction(String transName, String transData) {
		return createTransaction(transName, CAL_TRAN_TYPE, transData);
	}

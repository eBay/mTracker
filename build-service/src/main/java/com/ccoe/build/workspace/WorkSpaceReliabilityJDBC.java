...
import com.ccoe.build.reliability.ReportInfoMapper;
...
public class WorkSpaceReliabilityJDBC {
	...
	public ReportInfo getReportInfoBeforeDay(String day) {
		final String SQL = "select  sum(a.amount) total, " + 
				...
				"and a.source = 'RIDE' AND a.phase_id = 7 and a.ide_name != 'RIDE Older' and a.ide_name != 'Unknown' ";
		try {
	...
	public List<ErrorCode> getTopTenError(String errorCatagory) {
		final String SQL = " SELECT * FROM " + 
				   ...
				   " and b.source = 'RIDE' AND b.phase_id = 7 and b.ide_name != 'RIDE Older' and b.ide_name != 'Unknown' " +

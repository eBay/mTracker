...
public class ProcessHelperTest {
	...
	public void parsePayload() {
		...
		ProcessHelper.parseSessionPayLoad("git.url=https://github.scm.corp.ebay.com/DevExTech/OSGI-Maven-plugins;machine=D-SHC-00436998;uname=mmao;maven.version=e:\\bin\\apache-maven-3.0.5-RaptorTimeTracking\\bin\\..;java.version=1.6.0_38-b05", 
				session);
		assertEquals("https://github.scm.corp.ebay.com/DevExTech/OSGI-Maven-plugins", session.getGitUrl());
	...
	public void parseProjectPlayload() {
		...
		ProcessHelper.praseProjectPayload("com.ebay.osgi.build:obrgen-maven-plugin:maven-plugin:1.1.0-SNAPSHOT", project);
		assertEquals("com.ebay.osgi.build", project.getGroupId());

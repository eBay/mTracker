...
public class FileProperties {
	...
	public File getPreCacheListFile() {
		return new File(ROOT_DIR, this.appName + File.separator + PRE_CACHE_LIST_FILE);
	}

	public File getSettingXMLCacheMd5File() {
		return new File(ROOT_DIR, this.appName + File.separator + SETTING_XML_CACHE_MD5_FILE);
	}
}
